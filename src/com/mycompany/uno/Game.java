...
//            }
//            else if(card.getValue() != validValue){
//                JLabel message2 = new JLabel("Invalid player move" + validColor+ "but got color" + card.getColor());
//                message2.setFont(new Font("Arial", Font.BOLD, 48));
//                JOptionPane.showMessageDialog(null, message2);
//                throw new InvalidColorSubmissionException(message2, actual ,expected);
//            }
//        }
//
//        pHand.remove(card);
//        if(hasEmptyHand(this.playerIds[currentPlayer])){
//            JLabel message3 = new JLabel(this.playerIds[currentPlayer] + "Gano el juego");
//            message3.setFont(new Font("Arial", Font.BOLD, 48));
//            JOptionPane.showMessageDialog(null, message3);
//            System.exit(0);
//        }
...
//        }
//
//        if (card.getColor() == UnoCard.Color.Wild) {  // Asumo que debe ser WILD en mayúsculas
//            validColor = declaredColor;
//        }
//
//        if (card.getValue() == UnoCard.Value.DrawTwo) {  // Asumo que debe ser DRAW_TWO en mayúsculas
//            pid = playerIds[currentPlayer];
//            getPlayerHand(pid).add(deck.drawCard());
//            getPlayerHand(pid).add(deck.drawCard());
//            JLabel message = new JLabel(pid + "dibuja 2 cartas");
//        }
//        if (card.getValue() == UnoCard.Value.Wild_Four) {
//            pid = playerIds[currentPlayer];
//            getPlayerHand(pid).add(deck.drawCard());
